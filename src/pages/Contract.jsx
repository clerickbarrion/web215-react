...
function Contract() {
    ...
    return (
        <main>
            <h2>Contract</h2>
            <p>I, <a href="/introduction">Clerick D. Barrion</a>, agree to abide by the terms in my Spring 2025 WEB215-N801 Adv Markup and Scripting with my instructor, Professor D.I. von Briesen.</p>
